...
import { FavoratePageComponent } from '../favorate-page/favorate-page.component';
import { of } from 'rxjs';
...
export class RestaurantPageComponent implements OnInit {
  ...
  @ViewChild(FavoratePageComponent)
  child;
  ...
  setPageSizeOptions(setPageSizeOptionsInput: any) {
    if (setPageSizeOptionsInput) {
      this.pageSizeOptions = setPageSizeOptionsInput.split(',').pipe(map(str => +str));
    }
  }
